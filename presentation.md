...
author: |
	 Дмитревская Софья Алексеевна\inst{1}
...
![График численности групп](image/1.jpg){ #fig:001 width=70% height=70% }

## Графики изменения численности во втором случае
![График численности групп](image/2.jpg){ #fig:002 width=70% height=70% }
